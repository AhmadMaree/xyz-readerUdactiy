...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mPhotoView = (ImageView) mRootView.findViewById(R.id.image_Bar);
        loadingPb = (ProgressBar) mRootView.findViewById(R.id.loading_pb);
    ...
    private void showSnackbar(String text) {
        Snackbar.make(mRootView.findViewById(R.id.draw_insets_frame_layout), text, Snackbar.LENGTH_SHORT)
                .show();
    }
    @Override
